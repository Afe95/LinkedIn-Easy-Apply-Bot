import time, random, csv, pdb, traceback, sys, os
# import pyautogui
...
class LinkedinEasyApply:
    def __init__(self, parameters, driver):
        ...
        self.output_file_directory = os.path.join(script_directory, "data") #parameters['outputFileDirectory']
        print(self.output_file_directory)

        self.resume_dir = os.path.join(script_directory, "data/Giuseppe.pdf")
        print(self.resume_dir)
        ...
        if len(frm_el) > 0:
            for el in frm_el:
                ...
                try:
                    ...
                    elif 'Are you comfortable' in radio_text:
                        answer = "yes"
                    elif 'right' in radio_text:
                        answer = "yes"
                ...
                try:
                    ...
                    if 'proficiency' in question_text:
                        ...
                        self.select_dropdown(dropdown_field, choice)
                    elif 'legal right' in question_text:
                        answer = self.get_answer('legallyAuthorized')
    ...
    def write_to_file(self, company, job_title, link, location, search_location):
        ...
        file_path = os.path.join(self.output_file_directory, self.file_name + search_location + ".csv")
